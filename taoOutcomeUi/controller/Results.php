...
class Results extends tao_actions_SaSModule
{
    ...
    public function getResults()
    {
        ...
        try {
            ...
            $rights = array(
                ...
                'delete' => !AclProxy::hasAccess($user, 'oat\taoOutcomeUi\controller\Results', '', array()));
    ...
    public function delete()
    {
        ...
        $de1 = ServiceProxy::singleton()->getDeliveryExecution($deliveryExecutionUri);
    ...
    public function downloadXML()
    {
        try {
            ...
            header('Set-Cookie: fileDownload=false'); //used by jquery file download to find out the download has been triggered ...
            setcookie("fileDownload", "false", 0, "/");
